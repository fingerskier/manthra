const quotes = [{
    ...
    tag: ["inspiration", "craftsmanship", "intellect", "talent", "work", "study"]
  },{
    text: "Fruitless is inspiration without craftsmanship, is intellect without study, is talent without work.",
    author: 'Johannes Brahms',
    tag: ['inspiration', 'craftsmanship', 'intellect', 'talent', 'work']
  },{
    ...
    author: "Johannes Brahms",
    tag: ["music", "bible", "inspiration", "theology"]
  },{
   ...
   text: `some people can read "War and Peace" and come away thinking it's a simple adventure story. Others can read the ingredients on a chewing gum wrapper and unlock the secrets of the universe.`,
    ...
    author: 'Johannes Brahms',
    tag: ['craftsmanship', 'talent', 'study', 'skill', 'art', 'miracle', 'inspiration', 'theology']
  },{
    ...
    author: 'Johannes Brahms',
    tag: ['inspiration', 'craftsmanship', 'talent', 'skill', 'art']
  },{
    ...
    author: 'Johannes Brahms',
    tag: ['inspiration', 'craftsmanship', 'intellect', 'talent', 'work', 'study', 'skill']
  },{
    ...
    author: "Thomas Jefferson",
    tag: [ 'theology', 'freedom', 'liberty', 'rights', 'government', 'politics' ]
  },{
    text: "It is not hard to compose, but what is fabulously hard is to leave the superfluous notes under the table.",
    author: "Johannes Brahms",
    tag: ['inspiration', 'craftsmanship', 'intellect', 'talent', 'work', 'study', 'skill', 'composition']
  },{
    ...
    author: "Johannes Brahms",
    tag: ['inspiration', 'craftsmanship', 'talent', 'work', 'study', 'skill', 'composition']
  },{
